...
function run() {
    return __awaiter(this, void 0, void 0, function () {
        var lookupDays, ryanAirClient, wizzAirClient, airportsArrays, airports, unusableAirportCodes;
                ...
                case 1:
                    ...
                    airports = airports
                        ...
                        .map(function (airport) { return (__assign(__assign({}, airport), { connections: airport.connections
                            .filter(function (connection) { return !unusableAirportCodes.includes(connection.code); }) })); });
                    // Delete all airports and save new ones
                    return [4 /*yield*/, prisma_1.prisma.$transaction([
                            prisma_1.prisma.airport.deleteMany(),
                            prisma_1.prisma.airport.createMany({
                                data: airports
                            })
                        ])];
                case 2:
